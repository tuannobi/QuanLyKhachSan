 ...
 * @author Tuan
 */
public class ManHinhMainJFrame_LeTan extends javax.swing.JFrame {

    /**
     * Creates new form MainJFrame
     */
    NhanVienDTO nhanVienDTO;
    public ManHinhMainJFrame_LeTan() {
        initComponents();
    ...
    private void jpnThongKeDoanhThuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpnThongKeDoanhThuMouseClicked
        // TODO add your handling code here:
        ManHinhQuanLyThongKe_HoaDon thongKeJPanel = new ManHinhQuanLyThongKe_HoaDon();
        jpnView.removeAll();
        jpnView.setLayout(new BorderLayout());
    ...
    private void xuLyDangXuat() {
        dispose();
        ManHinhDangNhapJFrame dangNhapJFrame=new ManHinhDangNhapJFrame();
        dangNhapJFrame.showWindow();
