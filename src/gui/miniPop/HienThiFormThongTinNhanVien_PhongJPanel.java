 ...
 * @author Tuan
 */
public class HienThiFormThongTinNhanVien_PhongJPanel extends javax.swing.JPanel {

    JPanelPhong selecJPanelPhong;
    public HienThiFormThongTinNhanVien_PhongJPanel(JPanelPhong selectedJPanelPhong) {
        setVisible(true);
        initComponents();
