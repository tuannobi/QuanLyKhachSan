 ...
 * @author COMPUTER
 */
public class FormThemNhanVienJDialog extends javax.swing.JDialog {
   ...
   // ArrayList<NhanVienDTO> listNV;
    ...
    public FormThemNhanVienJDialog(ArrayList<NhanVienDTO> listNV, DefaultTableModel dtm,JTable jtable) throws SQLException {
        initComponents();
        setVisible(true);
    ...
    private void layThongTinDuLieuMoiTuForm()
    {
    ...
    private void initComponents() {
        ...
        jcbbNguoiQuanLy.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jbtLuu, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(64, 64, 64)
                        .addComponent(jbtHuy, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(40, 40, 40))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void yeuCauCapThemNhanVien() {
    boolean checkInput=kiemTraTinhDayDuTruong();
        if (checkInput){
        layThongTinDuLieuMoiTuForm();
        ...
        if (check==1){
            ...
            try {
                ...
                Logger.getLogger(FormThemNhanVienJDialog.class.getName()).log(Level.SEVERE, null, ex);
            }
            dispose();
            int checkA=JOptionPane.showConfirmDialog(null, "Tạo tài khoản cho nhân viên này?", "Tạo tài khoản", JOptionPane.YES_NO_OPTION);
            if (checkA==JOptionPane.YES_OPTION){
