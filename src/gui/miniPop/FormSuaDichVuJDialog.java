 ...
 * @author COMPUTER
 */
public class FormSuaDichVuJDialog extends javax.swing.JDialog {
...
//        jtfMaDichVu.disable();
//    }
    public FormSuaDichVuJDialog(ArrayList<DichVu> listDV, DefaultTableModel dtm,JTable jtable,DichVu dv ) {            
        initComponents();
        jtfMaDichVu.disable();
        this.dtm=dtm;
        this.jtable=jtable;
...
//    }
    ...
    private void lamMoiDuLieu(){
     ...
     private void luuThongTinDichVuNguoiDungMoiNhap() {
        newInfoDichVu=new DichVu();
        if (kiemTraTinhDayDuTruong()){
    ...
    private void initComponents() {
        ...
        jccbTrangThai.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(jpnMain, javax.swing.GroupLayout.PREFERRED_SIZE, 273, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void yeuCauCapNhatDichVu() {
        luuThongTinDichVuNguoiDungMoiNhap();
