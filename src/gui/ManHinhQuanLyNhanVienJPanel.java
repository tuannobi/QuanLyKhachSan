...
import gui.miniPop.FormSuaNhanVienJDialog;
import gui.miniPop.FormThemNhanVienJDialog;
 ...
 * @author Tuan
 */
public class ManHinhQuanLyNhanVienJPanel extends javax.swing.JPanel {
    ...
    public ManHinhQuanLyNhanVienJPanel() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(296, 49));
        ...
        jpnTimKiem.setPreferredSize(new java.awt.Dimension(386, 64));
        ...
        jpnTimKiemLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpnTimKiemLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jbtTimKiem, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jpnMainLayout.setHorizontalGroup(
            ...
            .addComponent(jpnThanhTren, javax.swing.GroupLayout.DEFAULT_SIZE, 1018, Short.MAX_VALUE)
        );
    ...
    private void jbtCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCapNhatActionPerformed
        if (selectedNV==null)
        {
            ...
            yeuCauhienThiFormCapNhatThongTinNhanVien();
        }
    ...
    listNV=NhanVienBus.layDuLieuNhanVien();
    ...
    public static void lamMoiDuLieu() throws SQLException
{
   ...
   private void hienThiDanhSachNhanVienTimKiem(String tk)
{
    ...
    private void luuThongTinNhanVienKhiClick() {
    ...
    private void yeuCauTimKiemNhanVien() {
       if (jtfTimKiem.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Nhập từ khóa");
            
        }
        else{
            hienThiDanhSachNhanVienTimKiem(jtfTimKiem.getText());
                }
    }

    private void yeuCauXoaNhanVien() {
    ...
    private void yeuCauHienThiFormThemNhanVien() {
        FormThemNhanVienJDialog ThemNhanVien;
        try {
            ThemNhanVien = new FormThemNhanVienJDialog(listNV, dtmNhanVien, tbNhanVien);
        } catch (SQLException ex) {
            Logger.getLogger(ManHinhQuanLyNhanVienJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private void yeuCauhienThiFormCapNhatThongTinNhanVien() {
        FormSuaNhanVienJDialog suaNhanVienJDialog;
            try {
                suaNhanVienJDialog = new FormSuaNhanVienJDialog(listNV, dtmNhanVien, tbNhanVien, selectedNV);
            } catch (SQLException ex) {
                Logger.getLogger(ManHinhQuanLyNhanVienJPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
